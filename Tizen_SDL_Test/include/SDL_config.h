...
#define SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_XDGSHELLCLIENT "libxdg-shell-client.so.0"
#define SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_TEXTCLIENT "libtext-client.so.0"
#define SDL_VIDEO_DRIVER_WAYLAND_DYNAMIC_TIZENEXTENSIONCLIENT "libtizen-extension-client.so.0"
